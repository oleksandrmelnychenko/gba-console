...
type PaymentCashflowArticlesPageProps = {
...
export function PaymentCashflowArticlesPage({ inSharedShell = false }: PaymentCashflowArticlesPageProps) {
  ...
  if (inSharedShell) {
    return (
      <Stack className="payment-cashflow-articles-page console-table-page payment-articles-tab-content" gap={0}>
        {content}
      </Stack>
    )
  }
  ...
  return (
    <Stack className="payment-cashflow-articles-page console-table-page" gap={6}>
      <div className="console-table-shell payment-cashflow-articles-card">{content}</div>
    </Stack>
  )
}
