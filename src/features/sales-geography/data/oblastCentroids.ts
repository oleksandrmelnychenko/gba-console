...
export const UA_OUTLINE: ReadonlyArray<readonly [number, number]> = [
  ...
  [38.2, 47.1],
  [37.5, 47.05],
  // Southern coastline includes Crimea, independent of sales aggregates.
  // Coordinate source: https://github.com/johan/world.geo.json/blob/master/countries/UKR.geo.json
  [36.759855, 46.6987],
  [35.823685, 46.645964],
  [34.962342, 46.273197],
  [35.020788, 45.651219],
