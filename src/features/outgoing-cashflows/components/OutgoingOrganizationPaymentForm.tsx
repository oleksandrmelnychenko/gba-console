...
export function OutgoingOrganizationPaymentForm({ onCancel, onCreated }: OutgoingOrganizationPaymentFormProps) {
  const { t } = useI18n()
            ...
            <Select
              ...
              description={
                selectedAgreement && typeof selectedAgreement.CurrentAmount === 'number'
                  ? `${t('Поточний договір')}: ${moneyFormatter.format(selectedAgreement.CurrentAmount)}`
                  : undefined
              }
