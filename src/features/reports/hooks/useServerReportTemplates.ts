  ...
  async function runTemplateOperation(operation: Operation) {
    ...
    try {
      if (operation.kind === 'remove') {
        ...
        if (request.Data.dataSource === 12 || request.Data.dataSource === 13 || request.Data.dataSource === 14 || request.Data.dataSource === 15 || request.Data.dataSource === 16 || request.Data.dataSource === 17 || request.Data.dataSource === 18 || request.Data.dataSource === 19) {
