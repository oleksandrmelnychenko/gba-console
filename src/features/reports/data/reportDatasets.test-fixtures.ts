...
export const netDataset: ReportDataset = {
  ...
  Groupings: subset(grossDataset.Groupings, [0, 1, 2, 3, 4, 5, 6, 7, 12, 15, 17, 18]),
  Filters: subset(grossDataset.Filters, [0, 2, 6, 9, 14]),
...
export const purchaseDataset: ReportDataset = {
  ...
  Groupings: [...subset(grossDataset.Groupings, [0, 1, 2, 3, 4, 5, 6, 7, 8, 21]),
