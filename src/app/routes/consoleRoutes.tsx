...
const migratedConsoleRoutes: ConsoleRoute[] = [
  ...
  { path: '/products/assortment', element: lazyRoute(<AssortmentDashboardPage />) },
  ...
  { path: '/orders/ukraine/to-ukraine/new', element: lazyRoute(<SupplyUkraineToUkraineOrderCreatePage />) },
...
const accountingMigrationRoutes: ConsoleRoute[] = [
  ...
  { path: '/accounting/payment-cashflow-articles', element: <PaymentArticlesPage /> },
  ...
  { path: '/accounting/payment-expense-articles', element: <PaymentArticlesPage /> },
...
const plannedConsoleRoutes: ConsoleRoute[] = [
  ...
  { path: '/sales/return/client', element: <Navigate replace to="/sales/ukraine/all/returns/new" /> },
