...
export const TEST_INCOME_SUPPLIERS: TestIncomeSupplier[] = [
  ...
  },
  {
    ...
    parse: { productCode: 3, customsValue: 11, uktzed: 1, duty: 12, price: 7, qty: 8, vat: 13, startRow: 5, endRow: 110, netWeight: 6, grossWeight: 5 },
    rows: 106,
    qty: 589,
    invoiceCurrency: 'USD',
  ...
  },
  {
    ...
    parse: { productCode: 3, customsValue: 11, uktzed: 1, duty: 12, price: 7, qty: 8, vat: 13, startRow: 5, endRow: 35, netWeight: 6, grossWeight: 5 },
    rows: 31,
    qty: 4035,
    invoiceCurrency: 'USD',
  ...
  },
  {
    ...
    parse: { productCode: 3, customsValue: 10, uktzed: 1, duty: 11, price: 7, qty: 8, vat: 12, startRow: 5, endRow: 47, netWeight: 6, grossWeight: 5 },
    rows: 43,
    qty: 549,
    invoiceCurrency: 'EUR',
  ...
  },
  {
    ...
    parse: { productCode: 3, customsValue: 10, uktzed: 1, duty: 11, price: 7, qty: 8, vat: 12, startRow: 5, endRow: 80, netWeight: 6, grossWeight: 5 },
    rows: 76,
    qty: 10170,
    invoiceCurrency: 'EUR',
  ...
  },
  {
    ...
    parse: { productCode: 3, customsValue: 10, uktzed: 1, duty: 11, price: 7, qty: 8, vat: 12, startRow: 5, endRow: 100, netWeight: 6, grossWeight: 5 },
    rows: 96,
    qty: 2900,
    invoiceCurrency: 'EUR',
  ...
  },
  {
    ...
    parse: { productCode: 3, customsValue: 10, uktzed: 1, duty: 11, price: 7, qty: 8, vat: 12, startRow: 5, endRow: 126, netWeight: 6, grossWeight: 5 },
    rows: 122,
    qty: 2216,
    invoiceCurrency: 'EUR',
    invoiceAmount: 21043,
